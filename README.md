...
Built with a **Laravel API Backend** and an **Angular 18 Frontend**, styled with a customized **Luxury Dark Theme** with golden accents, glassmorphic card layouts, responsive interactive tables, and live background status updates.
